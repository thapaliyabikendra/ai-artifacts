...
A skill is a folder of instructions, scripts, and resources that agents can discover and load dynamically to perform better at specific tasks. To be recognized as a skill, the folder must contain a `SKILL.md` file.
